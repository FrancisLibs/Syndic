...
exports.printForStatement = void 0;
const prettier_1 = __importDefault(require("prettier"));
const util_1 = __importDefault(require("../util"));
const { group, indent, line, hardline } = prettier_1.default.doc.builders;
const { EXPRESSION_NEEDED, isWhitespaceNode, indentWithHardline } = util_1.default;
...
const printForStatement = (node, path, print) => {
    ...
    const isBodyEmpty = node.body.expressions.length === 0 ||
...
exports.printForStatement = printForStatement;
