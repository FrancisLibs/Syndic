...
exports.printFilterExpression = void 0;
const melody_types_1 = require("melody-types");
const prettier_1 = __importDefault(require("prettier"));
const util_1 = __importDefault(require("../util"));
const { group, indent, line, softline, join } = prettier_1.default.doc.builders;
const { EXPRESSION_NEEDED, INSIDE_OF_STRING, STRING_NEEDS_QUOTES, FILTER_BLOCK, shouldExpressionsBeWrapped, wrapInStringInterpolation, someParentNode, isMultipartExpression, getDeepProperty, } = util_1.default;
...
const printArguments = (node, path, print, nodePath) => {
    ...
    if (node.arguments.length === 1 &&
        melody_types_1.Node.isObjectExpression(node.arguments[0])) {
...
const printFilterExpression = (node, path, print, options) => {
    ...
    while (melody_types_1.Node.isFilterExpression(currentNode.target)) {
...
exports.printFilterExpression = printFilterExpression;
