...
exports.hasTagEndTokenTrimRight = exports.hasTagStartTokenTrimLeft = exports.startNode = exports.createNode = exports.copyLoc = exports.getNodeSource = exports.copyEnd = exports.copyStart = exports.setMarkFromToken = exports.setEndFromToken = exports.setStartFromToken = void 0;
/**
...
function createNode(Type, token, ...args) {
    const node = setEndFromToken(setStartFromToken(new Type(...args), token), token);
